      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h2 className="text-3xl font-bold tracking-tight mb-2">
            {id === 'vfleet' ? 'vFleet Pilot' : 
             id === 'performaxxi' ? 'Performaxxi Único' : 
             id === 'ponto' ? 'Ponto e Absenteísmo' : 
             'Consolidador Final'}
          </h2>
          <p className="text-muted-foreground">
            {id === 'vfleet' 
              ...
              : 'Unificação de todas as fontes de dados para geração dos relatórios de pagamento finais.'}
          </p>
        </div>
