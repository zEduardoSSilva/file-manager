        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-2 sm:gap-4">
          <Card className="bg-primary text-primary-foreground min-w-0">
            <CardHeader className="flex flex-row items-center justify-between pb-1 sm:pb-2 space-y-0 p-3 sm:p-6">
              <CardTitle className="text-[9px] sm:text-xs font-medium uppercase tracking-wider truncate">Pipelines</CardTitle>
              <Database className="size-3 sm:size-4 opacity-70 shrink-0" />
            </CardHeader>
            <CardContent className="p-3 sm:p-6 pt-0 sm:pt-0">
              <div className="text-base sm:text-2xl font-bold">4</div>
              <p className="text-[8px] sm:text-xs opacity-70 truncate">Sistemas ativos</p>
            </CardContent>
          </Card>
          <Card className="min-w-0">
            <CardHeader className="flex flex-row items-center justify-between pb-1 sm:pb-2 space-y-0 p-3 sm:p-6">
              <CardTitle className="text-[9px] sm:text-xs font-medium uppercase tracking-wider truncate">Execuções</CardTitle>
              <FileCheck className="size-3 sm:size-4 text-muted-foreground shrink-0" />
            </CardHeader>
            <CardContent className="p-3 sm:p-6 pt-0 sm:pt-0">
              <div className="text-base sm:text-2xl font-bold">128</div>
              <p className="text-[8px] sm:text-xs text-muted-foreground truncate">+12% mês</p>
            </CardContent>
          </Card>
          <Card className="min-w-0">
            <CardHeader className="flex flex-row items-center justify-between pb-1 sm:pb-2 space-y-0 p-3 sm:p-6">
              <CardTitle className="text-[9px] sm:text-xs font-medium uppercase tracking-wider truncate">Motoristas</CardTitle>
              <Truck className="size-3 sm:size-4 text-muted-foreground shrink-0" />
            </CardHeader>
            <CardContent className="p-3 sm:p-6 pt-0 sm:pt-0">
              <div className="text-base sm:text-2xl font-bold">452</div>
              <p className="text-[8px] sm:text-xs text-muted-foreground truncate">Consolidado</p>
            </CardContent>
          </Card>
          <Card className="min-w-0">
            <CardHeader className="flex flex-row items-center justify-between pb-1 sm:pb-2 space-y-0 p-3 sm:p-6">
            ...
            <CardContent className="p-3 sm:p-6 pt-0 sm:pt-0">
              ...
              <p className="text-[8px] sm:text-xs text-muted-foreground truncate">Média global</p>
            </CardContent>
          </Card>
        </div>
            ...
            <CardContent className="grid gap-2 p-4 pt-0 sm:p-6 sm:pt-0 overflow-hidden">
              ...
              <Button variant="outline" className="w-full justify-start h-auto p-2 sm:p-4 text-left whitespace-normal break-words">
                <div className="flex items-center gap-2 sm:gap-3 w-full min-w-0">
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-semibold text-[11px] sm:text-sm leading-tight break-words">Parâmetros de Sistema</p>
                    <p className="text-[9px] text-muted-foreground leading-tight mt-0.5 truncate">Configurar regras de bonificação.</p>
                  </div>
                  <ArrowUpRight className="size-3 shrink-0 text-muted-foreground ml-auto" />
                </div>
              </Button>
